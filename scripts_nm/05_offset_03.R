...
Date1 <- as.Date("2025-04-30", "%Y-%m-%d")
Date2 <- as.Date("2025-05-01", "%Y-%m-%d")
subdf <- USF03[USF03$DateTime < Date2 & USF03$DateTime > Date1,]

ggplot(data=subdf, aes(DateTime,Baro_Cor_Lvl)) + geom_line() +
  geom_vline(xintercept = as.POSIXct("2025-05-01 12:30:00"), linetype="dashed", color="red") 
...
###########################################################################
# first move correction (2024-10-24 10:00:00)
move_time1 <- as.POSIXct("2024-10-24 09:35:00")
...
# # second move correction (2024-07-30 10:30:00)
# move_time2 <- as.POSIXct("2024-07-30 10:30:00")
# 
# before_move2 <- USF03 %>%
