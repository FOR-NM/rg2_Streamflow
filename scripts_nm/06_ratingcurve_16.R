...
########################################
ggplot(data = USF16, aes(x = DateTime, y = Baro_Cor_offset2)) +
...
plot(USF16$Baro_Cor_offset2, USF16$Predicted_Discharge_Log_m3s, col = "red", type = "l", lwd = 2,
     xlab = "Stage (m)", ylab = "Discharge (m³/s)", main = "Discharge Predictions")
lines(USF16$Baro_Cor_offset2, USF16$Predicted_Discharge_Linear_m3s, col = "green", lwd = 2)
...
ggplot(USF16, aes(x = Baro_Cor_offset2)) +
