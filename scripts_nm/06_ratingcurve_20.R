...
########################################
ggplot(data = USF20, aes(x = DateTime, y = Baro_Cor_offset3)) +
...
plot(USF20$Baro_Cor_offset3, USF20$Predicted_Discharge_Log_m3s, col = "red", type = "l", lwd = 2,
     xlab = "Stage (m)", ylab = "Discharge (m³/s)", main = "Discharge Predictions")
lines(USF20$Baro_Cor_offset3, USF20$Predicted_Discharge_Linear_m3s, col = "green", lwd = 2)
...
ggplot(USF20, aes(x = Baro_Cor_offset3)) +
