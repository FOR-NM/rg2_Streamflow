...
USF20$DateTime <- paste(USF20$Date, USF20$Time, sep = " ")
...
USF20 <- USF20 %>% 
  mutate(Baro_positive = Baro_Cor_offset2 + 100)
...
########################################
ggplot(data = USF20, aes(x = DateTime, y = Baro_Cor_offset1)) +
  geom_line() + ggtitle("USF20 compensated level data")

ggplot(data = USF20, aes(x = DateTime, y = Baro_positive)) +
  geom_line() + ggtitle("USF20 positive compensated level data")
...
plot(USF20$Baro_positive, USF20$Predicted_Discharge_Log_m3s, col = "red", type = "l", lwd = 2,
     xlab = "Stage (m)", ylab = "Discharge (m³/s)", main = "Discharge Predictions")
lines(USF20$Baro_positive, USF20$Predicted_Discharge_Linear_m3s, col = "green", lwd = 2)
...
ggplot(USF20, aes(x = Baro_positive)) +
