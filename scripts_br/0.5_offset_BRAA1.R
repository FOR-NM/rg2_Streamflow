...
move_time2 <- as.POSIXct("2025-03-03 10:00:00")  
before_move <- BRAA1 %>%
...
move_time3 <- as.POSIXct("2025-04-17 09:00:00")
before_move <- BRAA1 %>%
...
move_time6 <- as.POSIXct("2025-06-26 11:00:00")
before_move <- BRAA1 %>%
...
move_time7 <- as.POSIXct("2025-07-17 10:00:00")
before_move <- BRAA1 %>%
