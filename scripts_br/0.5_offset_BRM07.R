...
# p <- ggplot(data = BRM07_baro, aes(x = DateTime, y = Baro_Cor_Lvl.m)) +
#   geom_vline(xintercept = as.POSIXct("2025-03-14 12:00:00"), linetype="dashed", color="red") +
#   geom_line() + ggtitle("BRA01 compensated level data")
# #Automatically save plot
# ggsave(filename = "br_figs/BRM07_baro.png", plot = p,
...
#Automatically save plot
ggsave(filename = "br_figs/May31_BRM07_raw.png", plot = p,
       width = 8, height  = 6, dpi = 300)
...
Date1 <- as.Date("2025-01-02", "%Y-%m-%d")
Date2 <- as.Date("2025-01-10", "%Y-%m-%d")
subdf <- BRM07[BRM07$DateTime < Date2 & BRM07$DateTime > Date1,]
ggplot(data=subdf, aes(DateTime,Baro_Cor_Lvl.m)) + geom_line() +
  geom_vline(xintercept = as.POSIXct("2025-01-07 13:00:00"), linetype="dashed", color="red") 
...
ggplot(data=subdf, aes(DateTime,Baro_Cor_Lvl.m)) + geom_line() +
  ...
  geom_vline(xintercept = as.POSIXct("2025-03-18 23:00:00"), linetype="dashed", color="red")
...
subdf <- BRM07[BRM07$DateTime < Date2 & BRM07$DateTime > Date1,]
ggplot(data=subdf, aes(DateTime,Baro_Cor_Lvl.m)) + geom_line() +
  geom_vline(xintercept = as.POSIXct("2025-05-12 10:00:00"), linetype="dashed", color="red") +
  geom_vline(xintercept = as.POSIXct("2025-05-16 10:00:00"), linetype="dashed", color="red") +
  geom_vline(xintercept = as.POSIXct("2025-05-29 10:00:00"), linetype="dashed", color="red")
...
subdf <- BRM07[BRM07$DateTime < Date2 & BRM07$DateTime > Date1,]
ggplot(data=subdf, aes(DateTime,Baro_Cor_Lvl.m)) + geom_line() +
  geom_vline(xintercept = as.POSIXct("2025-06-26 18:00:00"), linetype="dashed", color="red") 

Date1 <- as.Date("2025-06-15", "%Y-%m-%d")
Date2 <- as.Date("2025-06-30", "%Y-%m-%d")
subdf <- BRM07[BRM07$DateTime < Date2 & BRM07$DateTime > Date1,]
ggplot(data=subdf, aes(DateTime,Baro_Cor_Lvl.m)) + geom_line() +
  geom_vline(xintercept = as.POSIXct("2025-06-21 14:00:00"), linetype="dashed", color="red") 

Date1 <- as.Date("2025-09-01", "%Y-%m-%d")
...
subdf <- BRM07[BRM07$DateTime < Date2 & BRM07$DateTime > Date1,]
ggplot(data=subdf, aes(DateTime,Baro_Cor_Lvl.m)) + geom_line() +
  geom_vline(xintercept = as.POSIXct("2024-10-17 10:00:00"), linetype="dashed", color="red") +
...
move_time2 <- as.POSIXct("2025-06-21 14:00:00")  
before_move <- BRM07 %>%
...
move_time3 <- as.POSIXct("2025-04-16 10:00:00") 
before_move <- BRM07 %>%
...
move_time4 <- as.POSIXct("2025-03-03 12:00:00")
before_move <- BRM07 %>%
...
p <- ggplot(rating_data_offset, aes(x = Baro_Cor_offset5, y = Q.m3s, color = Season)) +
  ...
  geom_text(aes(label = Date.x), vjust = -0.5, size = 3, show.legend = FALSE) +
  labs(
    title = "Stage vs. Discharge by Season - BRM07",
    x = "Stage (LEVEL m)",
    y = "Discharge (Q m³/s)",
    color = "Season"
  ) +
...
#Automatically save plot
ggsave(filename = "br_figs/Season_BRM07.png", plot = p,
       width = 8, height  = 6, dpi = 300)
...
#Automatically save plot
ggsave(filename = "br_figs/May31_BRM07.png", plot = p,
       width = 8, height  = 6, dpi = 300)
...
#Automatically save plot
ggsave(filename = "br_figs/SaltSlug_vs_FlowMeter_BRM07.png", plot = p,
       width = 8, height  = 6, dpi = 300)

########################
#### Plot close ups ####
########################
# ("2025-01-23 15:00:00") ("2025-05-16 10:00:00") ("2025-04-16 10:00:00") ("2025-06-21 14:00:00")  ("2024-10-11 12:00:00")

Date1 <- as.Date("2024-10-09", "%Y-%m-%d")
...
Date1 <- as.Date("2025-02-27", "%Y-%m-%d")
Date2 <- as.Date("2025-03-08", "%Y-%m-%d")
subdf <- BRM07[BRM07$DateTime < Date2 & BRM07$DateTime > Date1,]
ggplot(data=subdf, aes(DateTime,Baro_Cor_Lvl.m)) + geom_line() +
  geom_vline(xintercept = as.POSIXct("2025-02-28 18:00:00"), linetype="dashed", color="red") 
ggplot(data=subdf, aes(DateTime,Baro_Cor_offset4)) + geom_line() +
  geom_vline(xintercept = as.POSIXct("2025-02-28 17:00:00"), linetype="dashed", color="red") 
