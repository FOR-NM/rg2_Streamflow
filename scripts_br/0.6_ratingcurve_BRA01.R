...
plot(BRA01$Baro_Cor_Lvl.m, BRA01$Predicted_Discharge_Log.m3s, col = "red", type = "l", lwd = 2,
     xlab = "Stage (m)", ylab = "Discharge (m³/s)", main = "Discharge Predictions")
lines(BRA01$Baro_Cor_Lvl.m, BRA01$Predicted_Discharge_Linear.m3s, col = "green", lwd = 2)
...
ggplot(BRA01, aes(x = Baro_Cor_Lvl.m)) +
