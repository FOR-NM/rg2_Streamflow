...
plot(BRMQ1$Baro_Cor_Lvl.m, BRMQ1$Predicted_Discharge_Log, col = "red", type = "l", lwd = 2,
     xlab = "Stage (m)", ylab = "Discharge (m³/s)", main = "Discharge Predictions")
lines(BRMQ1$Baro_Cor_Lvl.m, BRMQ1$Predicted_Discharge_Linear, col = "green", lwd = 2)
...
ggplot(BRMQ1, aes(x = Baro_Cor_Lvl.m)) +
