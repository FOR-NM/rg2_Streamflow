...
#SST05
googledrive::drive_download(file = pt_csvs$id[pt_csvs$name=="10-04-2024_SST05_PTS_SN2192883..csv"], 
                            path = "googledrive/10-04-2024_SST05_PTS_SN2192883..csv",
                            overwrite = T)
# Load file
SST05 <- read.csv("googledrive/10-04-2024_SST05_PTS_SN2192883..csv")
...
# Replace broken values with NA in the Q..L.s. column
SST05$Q..L.s.[SST05$Q..L.s. == "#DIV/0!"] <- NA
...
lines(SST05$Baro_Cor_Lvl.m, SST05$Predicted_Discharge_Poly, col = "purple", lwd = 2)
...
ggplot(SST05, aes(x = DateTime, y = Predicted_Discharge_Poly)) +
  geom_point(color = "blue") +
