...
#SST08
googledrive::drive_download(file = pt_csvs$id[pt_csvs$name=="09-16-2024_SST08_PTS_SN2192632.csv"], 
                            path = "googledrive/09-16-2024_SST08_PTS_SN2192632.csv",
                            overwrite = T)
# Load file
SST08 <- read.csv("googledrive/09-16-2024_SST08_PTS_SN2192632.csv")
...
plot(SST08$Baro_Cor_Lvl.m, SST08$Predicted_Discharge_Log, col = "red", type = "l", lwd = 2,
     xlab = "Stage (m)", ylab = "Discharge (m³/s)", main = "Discharge Predictions")
lines(SST08$Baro_Cor_Lvl.m, SST08$Predicted_Discharge_Linear, col = "green", lwd = 2)
lines(SST08$Baro_Cor_Lvl.m, SST08$Predicted_Discharge_Poly, col = "purple", lwd = 2)
...
ggplot(SST08, aes(x = Baro_Cor_Lvl.m)) +
...
ggplot(SST08, aes(x = DateTime, y = Predicted_Discharge_Poly)) +
  geom_point(color = "blue") +
