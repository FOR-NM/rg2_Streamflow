...
#SST13
googledrive::drive_download(file = pt_csvs$id[pt_csvs$name=="offset_SST13.csv"], 
                            path = "googledrive/offset_SST13.csv",
                            overwrite = T)
# load file
SST13 <- read.csv("googledrive/offset_SST13.csv")
...
#####################################################################
#### Clean data from before the PT move from site SST02 to SST13 ####
#####################################################################
SST13 <- SST13 %>%
