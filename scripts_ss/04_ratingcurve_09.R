...
plot(SST09$Baro_Cor_Lvl.m, SST09$Predicted_Discharge_Log, col = "red", type = "l", lwd = 2,
     xlab = "Stage (m)", ylab = "Discharge (m³/s)", main = "Discharge Predictions")
lines(SST09$Baro_Cor_Lvl.m, SST09$Predicted_Discharge_Linear, col = "green", lwd = 2)
lines(SST09$Baro_Cor_Lvl.m, SST09$Predicted_Discharge_Poly, col = "purple", lwd = 2)
...
ggplot(SST09, aes(x = Baro_Cor_Lvl.m)) +
...
ggplot(SST09, aes(x = DateTime, y = Predicted_Discharge_Poly)) +
  geom_point(color = "blue") +
