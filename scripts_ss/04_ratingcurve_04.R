...
#SST04
googledrive::drive_download(file = pt_csvs$id[pt_csvs$name=="09-16-2024_SST04_PTS_SN2192624.csv"], 
                            path = "googledrive/09-16-2024_SST04_PTS_SN2192624.csv",
                            overwrite = T)
# Load file
SST04 <- read.csv("googledrive/09-16-2024_SST04_PTS_SN2192624.csv")
...
plot(SST04$Baro_Cor_Lvl.m, SST04$Predicted_Discharge_Log, col = "red", type = "l", lwd = 2,
     xlab = "Stage (m)", ylab = "Discharge (m³/s)", main = "Discharge Predictions")
lines(SST04$Baro_Cor_Lvl.m, SST04$Predicted_Discharge_Linear, col = "green", lwd = 2)
lines(SST04$Baro_Cor_Lvl.m, SST04$Predicted_Discharge_Poly, col = "purple", lwd = 2)
...
ggplot(SST04, aes(x = Baro_Cor_Lvl.m)) +
...
ggplot(SST04, aes(x = DateTime, y = Predicted_Discharge_Poly)) +
  geom_point(color = "blue") +
