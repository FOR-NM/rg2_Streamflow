...
plot(SSM01$Baro_Cor_Lvl.m, SSM01$Predicted_Discharge_Log, col = "red", type = "l", lwd = 2,
     xlab = "Stage (m)", ylab = "Discharge (m³/s)", main = "Discharge Predictions")
lines(SSM01$Baro_Cor_Lvl.m, SSM01$Predicted_Discharge_Linear, col = "green", lwd = 2)
lines(SSM01$Baro_Cor_Lvl.m, SSM01$Predicted_Discharge_Poly, col = "purple", lwd = 2)
...
ggplot(SSM01, aes(x = Baro_Cor_Lvl.m)) +
...
ggplot(SSM01, aes(x = DateTime, y = Predicted_Discharge_Log)) +
  geom_point(color = "blue") +
  labs(title = "Predicted Discharge (Log)", x = "DateTime", y = "Discharge (m3/s)") +
  scale_x_datetime(date_breaks = "1 week") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))

ggplot(SSM01, aes(x = DateTime, y = Predicted_Discharge_Linear)) +
  geom_point(color = "blue") +
  labs(title = "Predicted Discharge (Linear)", x = "DateTime", y = "Discharge (m3/s)") +
  scale_x_datetime(date_breaks = "1 week") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))

ggplot(SSM01, aes(x = DateTime, y = Predicted_Discharge_Poly)) +
  geom_point(color = "blue") +
