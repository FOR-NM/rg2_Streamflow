...
#DVNWT4
googledrive::drive_download(file = pt_csvs$id[pt_csvs$name=="offset_DVNWT4.csv"], 
...
########################################
ggplot(data = DVNWT4, aes(x = DateTime, y = Baro_Cor_offset1)) +
...
plot(DVNWT4$Baro_Cor_offset1, DVNWT4$Predicted_Discharge_Log_m3s, col = "red", type = "l", lwd = 2,
     xlab = "Stage (m)", ylab = "Discharge (m³/s)", main = "Discharge Predictions")
lines(DVNWT4$Baro_Cor_offset1, DVNWT4$Predicted_Discharge_Linear_m3s, col = "green", lwd = 2)
...
ggplot(DVNWT4, aes(x = Baro_Cor_offset1)) +
