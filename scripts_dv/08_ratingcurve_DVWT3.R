...
########################################
ggplot(data = DVWT3, aes(x = DateTime, y = Baro_Cor_offset3)) +
...
plot(DVWT3$Baro_Cor_offset3, DVWT3$Predicted_Discharge_Log_m3s, col = "red", type = "l", lwd = 2,
     xlab = "Stage (m)", ylab = "Discharge (m³/s)", main = "Discharge Predictions")
lines(DVWT3$Baro_Cor_offset3, DVWT3$Predicted_Discharge_Linear_m3s, col = "green", lwd = 2)
...
ggplot(DVWT3, aes(x = Baro_Cor_offset3)) +
