...
# DVWT3
googledrive::drive_download(file = pt_csvs$id[pt_csvs$name=="depth_corrected_DVWT3.csv"],
                            path = "googledrive/depth_corrected_DVWT3.csv",
                            overwrite = T)
# load file
DVWT3 <- read.csv("googledrive/depth_corrected_DVWT3.csv")
...
write.csv(rating_data, "DVWT3_rating.csv")
...
########################################
ggplot(data = DVWT3, aes(x = DateTime, y = Final_Water_Depth_m)) +
...
ggplot(rating_data, aes(x = Final_Water_Depth_m, y = Q.m3s)) +
  ...
  labs(title = "Stage vs. Discharge - DVWT3", x = "Stage (LEVEL m)", y = "Discharge (Q m³/s)") +
  theme_minimal()
...
plot(DVWT3$Final_Water_Depth_m, DVWT3$Predicted_Discharge_Log_m3s, col = "red", type = "l", lwd = 2,
     xlab = "Stage (m)", ylab = "Discharge (m³/s)", main = "Discharge Predictions")
lines(DVWT3$Final_Water_Depth_m, DVWT3$Predicted_Discharge_Linear_m3s, col = "green", lwd = 2)
...
ggplot(DVWT3, aes(x = Final_Water_Depth_m)) +
...
ggplot(DVWT3, aes(x = DateTime, y = Predicted_Discharge_Log_m3s)) +
  ...
  labs(title = "Predicted Discharge DVWT3", x = "DateTime", y = "Discharge (m3/s)") +
